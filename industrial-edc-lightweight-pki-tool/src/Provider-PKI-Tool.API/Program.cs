...
using Provider_PKI_Tool.API.Services.Implementation;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Provider PKI Tool API",
        Version = "v1",
        Description = "API for managing PKI operations (CSR, Sign, Revoke)"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Provider PKI Tool API v1");
